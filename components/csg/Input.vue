...
const props = defineProps({
	align: {
		...
		type: String,
		validator: (value) => {
			return ['center', 'end', 'justify', 'left', 'right', 'start'].includes(value)
		}
	},
	bgColor: {
		default: 'black',
	...
	fontSize: {
		...
		type: String,
		validator: (value) => {
			return ['xs', 'sm', 'base', 'lg', 'xl', '2xl', '3xl', '4xl', '5xl', '6xl', '7xl', '8xl', '9xl'].includes(value)
		}
	},
	isDisabled: {
		default: false,
...
const computedClasses = computed(() => {
	...
	if (props.isRounded) classes += props.isRounded ? 'csg-input--rounded' : ''
	if (props.size) classes += ` csg-input--${props.size}`
	if (props.paddingSize) classes += ` csg-input--padding-${props.paddingSize}`
	if (props.textSize) classes += ` csg-input--text-${props.textSize}`
	if (props.isDisabled) classes += ' csg-input--disabled'
...
<style lang="scss">
  .csg-input {
    ...
    &--padding {
      &-xs .csg-input__input-wrapper {
        @apply px-1.5;
        @apply p-1;
      }

      &-sm .csg-input__input-wrapper {
        @apply px-2;
        @apply py-1;
      }

      &-md .csg-input__input-wrapper {
        @apply px-3;
        @apply py-2;
      }

      &-lg .csg-input__input-wrapper {
        @apply p-3;
      }

      &-xl .csg-input__input-wrapper {
        @apply p-4;
      }
    }

    &--rounded .csg-input__input-wrapper {
      @apply rounded-lg;
    }
    ...
    &--disabled .csg-input__input-wrapper {
      @apply bg-gray-50;
