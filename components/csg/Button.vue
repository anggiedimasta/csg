...
const computedClasses = computed(() => {
	...
	if (props.size) classes += ` csg-button--${props.size}`
	if (props.paddingSize) classes += ` csg-button--padding-${props.paddingSize}`
	if (props.fontWeight) classes += ` csg-button--font-weight-${props.fontWeight}`
	if (props.textSize) classes += ` csg-button--text-${props.textSize}`
	if (props.isLoading) classes += ' csg-button--loading'
