...
const pageInfoFrom = computed(() => {
	return props.totalRows ? props.perPage * props.currentPage - props.perPage + 1 : 0
})
const pageInfoTo = computed(() => {
	return props.perPage * props.currentPage > props.totalRows ? props.totalRows : props.perPage * props.currentPage
})
